  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6">
      ...
      <p className="mt-3 text-sm text-muted-foreground">
        Prefer not to run the steps yourself? View a fully populated{" "}
        <a href="/demo" className="underline">completed demo</a> with all eight steps already
        executed against the bundled Buffett corpus.
      </p>
